...
namespace MyGameCore
{
    ...
    // ウインドウの初期化
    bool Window::Initialize(HINSTANCE hInstance, const std::string& className, const std::string& titleName) {

        WNDCLASSEX	wcex;
        wcex.hInstance = hInstance;                                 // インスタンス値のセット
        wcex.lpszClassName = className.c_str();                     // クラス名
